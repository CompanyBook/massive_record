...
# to pass a regex in the column qualifier.
          ...
          class Append_args
            ...
            FIELDS = {
              ...
              APPEND => {:type => ::Thrift::Types::STRUCT, :name => 'append', :class => ::Apache::Hadoop::Hbase::Thrift::TAppend}
            }
...
# column in question
              ...
              MPUT => {:type => ::Thrift::Types::STRUCT, :name => 'mput', :class => ::Apache::Hadoop::Hbase::Thrift::Mutation},
              # Mutation attributes
              ATTRIBUTES => {:type => ::Thrift::Types::MAP, :name => 'attributes', :key => {:type => ::Thrift::Types::STRING, :binary => true}, :value => {:type => ::Thrift::Types::STRING, :binary => true}}
            }
